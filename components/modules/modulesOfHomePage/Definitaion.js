import styles from "./Definitaion.module.css";
...
const Definitaion = () => {
    ...
    return (
        ...
        <div className={styles.container}>
            ...
            <p className={styles.paraText}>BotoFood company was founded in 2009 by Garrett Camp and Travis
                ...
                commenced operations in both London and Paris.</p>
